...
-(void)setPath:(NSString*)newPath
{
    if (newPath && [newPath hasSuffix:@".app"]) {
        NSString* tempFileLocator = [newPath stringByAppendingString:@"/Contents/.wineskin_manager"];
...
-(NSString*)installWinetrick:(NSString*)winetrick
{
    ...
    NSString* logPath = [NSString stringWithFormat:@"%@/Contents/SharedSupport/prefix/winetricks.log",self.path];
...
{
    NSString* winetricksPath = [NSString stringWithFormat:@"%@/Contents/Resources/winetricks",self.path];
