...
+(NSString*)getWineskinWrapperEngineFromVersionFileOfPortAtPath:(NSString*)path
{
    @autoreleasepool
    {
        ...
        if (![[NSFileManager defaultManager] regularFileExistsAtPath:wswineVersion]) {
            NSString* wineskinEngineBundlePath = [NSString stringWithFormat:@"%@/Contents/Frameworks/wswine.bundle",path];
...
-(BOOL)isCompatibleWith32on64
{
    switch (self.engineType) {
        ...
        case NSWineskinEngineCrossOver:
            // CrossOver 19 is based on wine 4.12-1
            // https://www.codeweavers.com/products/more-information/changelog#19.0.0
            return [self isEngineVersionAtLeast:@"19.0.0"];
...
//TODO: wine-6.0 is the minimum change to wine-7.0 after wine-8.0
-(BOOL)isWineModernEnough
{
    switch (self.engineType) {
        ...
        case NSWineskinEngineCrossOver:
            // CrossOver 21 is based on wine 6.0
            // https://www.codeweavers.com/products/more-information/changelog#21.0.0
            return [self isEngineVersionAtLeast:@"21.0.0"];

        case NSWineskinEngineWineStaging:
            return [self isEngineVersionAtLeast:@"6.0"];
